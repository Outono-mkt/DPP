...
export const libraryMaterials: LibraryMaterial[] = [
  ...
  {
    id: "dia-4-checklist-publicacao-hotmart",
    titulo: "Checklist - Publicacao na Hotmart",
    tipo: "checklist",
    dia: "dia-4",
    ordem: 1,
    descricao: "Abra o checklist executivo para revisar a publicacao do produto na Hotmart.",
    prioridade: "essencial",
    tempoEstimado: "15 min",
    ferramenta: "Checklist Produto Pronto",
    paraQueServe: "Conferir os principais pontos antes de publicar e liberar o produto para venda.",
    resultadoEsperado: "Produto revisado para publicacao com menos risco de esquecer etapas importantes.",
    arquivoUrl: "/checklist/",
    tags: ["checklist", "hotmart", "publicacao"],
    disponivel: true,
  },
  {
